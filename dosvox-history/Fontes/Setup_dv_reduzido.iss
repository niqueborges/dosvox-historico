; INSTALADOR DO DOSVOX VERSÃO 6.3 reduzido
; POR: NENO ALBERNAZ
; EM MARÇO DE 2025 - Geração da versão 6.3 reduzido do Dosvox multiplataforma Windows (X86/X64).

; Deve executar o arquivo \wv\fontes\Prepara_DV_reduzido.bat.
; Serão excluidos da versão completa:
; O conteudo da pasta "\wv\Jogavox"
; A pasta "wv\Manual\audios"
; A pasta "wv\midias"
; o Instalador do K-Lite Codec Pack da pasta \wv_exter\Instaladores
...
OutputDir=\DV_Setup
OutputBaseFilename=dv63-reduzido-setup
;Compression=lzma
